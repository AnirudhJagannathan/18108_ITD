...
public class BlueLeft extends OpMode {
    ...
    private final Pose scorePose = new Pose(25, 12, Math.toRadians(0));
    ...
    public void buildPaths() {
        ...
        grabPickup1 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(scorePose), new Point(scoreControl), new Point(scoreControl2), new Point(pickup1Pose)))
