...
public class FConstants {
    static {
        ...
        FollowerConstants.translationalPIDFCoefficients.setCoefficients(1.8,0,0.4,0);
        ...
        FollowerConstants.secondaryHeadingPIDFCoefficients.setCoefficients(0.4,0,0.1,0); // Not being used, @see useSecondaryHeadingPID

        FollowerConstants.drivePIDFCoefficients.setCoefficients(0.027,0,0.003,0.6,0);
